...
function PostCard({ title, content, imageUrl, forumName, author, postId }) {
  // const { userId } = useAuth(); // Uncomment if you need userId for any reason
  return (
    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow hover:shadow-md transition">
      ...
      <div className="flex justify-between items-center">
        <Link to={`/posts/${postId}`} className="text-accent hover:underline text-sm"> 
          View full post →
        </Link>
